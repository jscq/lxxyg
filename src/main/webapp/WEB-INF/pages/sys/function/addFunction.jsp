		...
		<div class="cell">
			<table border="0" cellpadding="0" cellspacing="0">
				<tr>
		            ...
		            <td style="width:35%;"><input type="text" id="functionName" name="function.functionName" class="form_text" maxlength="25" reg="Require" tip="请填写功能名称"/></td>
		            
		            <th style="width:15%;">链接地址：</th>
		            <td style="width:35%;"><input type="text" name="function.functionUrl" class="form_text"/></td>
		       </tr> 
		       <tr>
		        	<th>功能编码：</th>
		            <td><input type="text" name="function.functionCode" class="form_text" maxlength="25"/></td>
